...
public class RetryHandler implements Runnable {
    ...
    public RetryHandler(RetryInfo retryInfo, RetryInfoMananger retryInfoMananger) {
        this.retryInfo = retryInfo;
        this.retryInfoMananger = retryInfoMananger;
    }

    @Override
    @Transactional
    public void run() {
        retry(retryInfo, retryInfoMananger);
    }
